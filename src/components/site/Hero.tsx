          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-10">
              ...
              <span className="text-[#a8c941] text-xs font-bold uppercase tracking-[0.2em]">
                Piraí do Sul · Paraná · CRMV-PR 18808
              </span>
            </div>

            {/* Heading principal */}
            <h1 className="text-[clamp(2.8rem,6vw,5rem)] font-bold text-white leading-[1.02] tracking-tight mb-6">
            ...
            <p className="text-white/55 text-lg leading-relaxed mb-10 max-w-[520px]">
              Cirurgias especializadas, diagnóstico preciso e suporte contínuo ao tutor.
              Tecnologia de ponta sob a direção do{" "}
            ...
            <div className="flex flex-wrap gap-3 mb-14">
              <a
                ...
                className="inline-flex items-center gap-2.5 px-7 py-4 bg-[#a8c941] hover:bg-[#bdd84e] text-[#001020] font-bold rounded-2xl transition-all text-sm tracking-wide shadow-[0_0_40px_rgba(168,201,65,0.25)] hover:shadow-[0_0_60px_rgba(168,201,65,0.4)]"
              >
                <Calendar size={17} />
                Agendar Consulta
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2.5 px-7 py-4 bg-white/[0.06] hover:bg-white/[0.1] text-white font-semibold rounded-2xl transition-all text-sm border border-white/[0.12] backdrop-blur-sm"
              >
                <Phone size={16} />
                Urgência
              </a>
            ...
            <div className="flex items-center gap-8 pt-8 border-t border-white/[0.08]">
              {[
                ...
                { value: "ANCLIVEPA-SC", label: "Especialização" },
              ].map((stat) => (
                <div key={stat.label}>
            ...
            <div className="relative">
              ...
              <div className="relative rounded-3xl overflow-hidden bg-[#001830] h-[540px]">
                <Image
                  ...
                  priority
                />
                {/* Gradiente inferior para integrar com fundo */}
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="bg-white/[0.06] backdrop-blur-md border border-white/[0.1] rounded-2xl px-5 py-4">
                  ...
                  <p className="text-white/40 text-xs mt-1">{DOCTOR.crmv} · ANCLIVEPA-SC</p>
                </div>
              </div>
            </div>
