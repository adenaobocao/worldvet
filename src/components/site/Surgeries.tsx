    ...
    <section id="cirurgias" className="py-24 bg-[#f8faf5]">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="max-w-2xl mx-auto text-center mb-16">
          <p className="text-[#a8c941] text-sm font-bold uppercase tracking-widest mb-3">Nossa especialidade</p>
          <h2 className="text-4xl lg:text-5xl font-bold text-[#003957] mb-4 leading-tight">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {surgeries.map((surgery) => (
            <div
              key={surgery.title}
              className="bg-white rounded-2xl p-6 border border-[#c6ccb0]/30 shadow-[0_4px_24px_rgba(0,57,87,0.06)] hover:shadow-[0_8px_40px_rgba(0,57,87,0.14)] hover:-translate-y-1 transition-all duration-300 group"
            >
              <div className="w-12 h-12 bg-[#003957]/8 rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#003957] transition-colors">
                <surgery.icon size={22} className="text-[#003957] group-hover:text-white transition-colors" />
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                {surgery.examples.map((ex) => (
                  <span key={ex} className="text-xs px-2.5 py-1 bg-[#f8faf5] text-[#003957]/70 rounded-lg border border-[#c6ccb0]/40">
                    {ex}
                  </span>
                ))}
              </div>
        ...
        <div className="text-center">
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-[#003957] hover:bg-[#004d70] text-white font-bold rounded-xl transition-all shadow-lg hover:shadow-xl text-base"
          >
