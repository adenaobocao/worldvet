    ...
    <section className="py-24 bg-gradient-to-br from-[#f8faf5] to-[#e8f0e0]">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-3xl p-10 lg:p-14 border border-[#c6ccb0]/30 shadow-[0_8px_48px_rgba(0,57,87,0.12)] text-center">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
              {features.map((feat) => (
                <div key={feat.text} className="flex flex-col items-center gap-2 p-4 bg-[#f8faf5] rounded-xl border border-[#c6ccb0]/30">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/tutor"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#003957] hover:bg-[#004d70] text-white font-bold rounded-xl transition-all shadow-lg hover:shadow-xl text-base"
              >
                <User size={18} />
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-4 border-2 border-[#003957] text-[#003957] hover:bg-[#003957] hover:text-white font-bold rounded-xl transition-all text-base"
              >
                Solicitar acesso
              </a>
            </div>
