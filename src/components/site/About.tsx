    ...
    <section id="sobre" className="py-24 bg-white">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Text */}
          <div>
            <p className="text-[#a8c941] text-sm font-bold uppercase tracking-widest mb-3">Sobre a Clínica</p>
            ...
            <p className="text-gray-600 leading-relaxed mb-8">
              Com equipamentos de ponta e uma equipe especializada liderada pelo Dr. Matheus A. F. Martins, realizamos desde consultas de rotina até cirurgias de alta complexidade, com o cuidado e a atenção que cada animal merece.
            </p>
          ...
          <div className="grid grid-cols-2 gap-4">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="bg-[#f8faf5] rounded-2xl p-6 border border-[#c6ccb0]/30 hover:border-[#a8c941]/40 transition-all group hover:shadow-[0_8px_32px_rgba(0,57,87,0.1)] hover:-translate-y-1"
              >
